...
class TestIntegration:
    ...
    def test_verifier_integration(self):
        ...
        pcap = PCAP(
            ...
            justification=VJustification(
                time_ms=100, retries=0, backtracks=0, audit_cost=1.0, risk=0.1, tech_debt=0
            ),
    ...
    def test_metrics_collector_integration(self):
        ...
        pcaps = [
            ...
            PCAP(
                ...
                justification=VJustification(
                    time_ms=200, retries=1, backtracks=0, audit_cost=2.0, risk=0.2, tech_debt=1
                ),
                proofs=[],
                verdict="fail",
                toolchain={},
    ...
    def test_end_to_end_workflow(self):
        ...
        result = planner.execute_plan(
            initial_state, "sanitize user input", {"time_limit_ms": 10000, "max_retries": 2}
        )
