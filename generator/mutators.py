...
class ActionGenerator:
    ...
    def propose_actions(
        self, goal: str, obligations: List[Dict[str, Any]], seed: int = None, k: int = 3
    ) -> List[ActionVariant]:
        """
    ...
    def _generate_sanitize_variants(
        self, goal: str, obligations: List[Dict[str, Any]], k: int
    ) -> List[ActionVariant]:
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=100, retries=0, backtracks=0, audit_cost=0.5, risk=0.2, tech_debt=0
                ),
                confidence=0.8,
            )
        )
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=80, retries=0, backtracks=0, audit_cost=0.3, risk=0.1, tech_debt=0
                ),
                confidence=0.9,
            )
        )
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=120, retries=0, backtracks=0, audit_cost=0.7, risk=0.3, tech_debt=0
                ),
                confidence=0.7,
            )
        )
    ...
    def _generate_rate_limit_variants(
        self, goal: str, obligations: List[Dict[str, Any]], k: int
    ) -> List[ActionVariant]:
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=90, retries=0, backtracks=0, audit_cost=0.4, risk=0.2, tech_debt=0
                ),
                confidence=0.8,
            )
        )
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=150, retries=0, backtracks=0, audit_cost=0.6, risk=0.3, tech_debt=0
                ),
                confidence=0.6,
            )
        )
    ...
    def _generate_pure_variants(
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=110, retries=0, backtracks=0, audit_cost=0.5, risk=0.1, tech_debt=0
                ),
                confidence=0.9,
            )
        )
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=70, retries=0, backtracks=0, audit_cost=0.2, risk=0.1, tech_debt=0
                ),
                confidence=0.8,
            )
        )
    ...
    def _generate_generic_variants(
        self, goal: str, obligations: List[Dict[str, Any]], k: int
    ) -> List[ActionVariant]:
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=50, retries=0, backtracks=0, audit_cost=0.1, risk=0.1, tech_debt=0
                ),
                confidence=0.9,
            )
        )
        ...
        variants.append(
            ActionVariant(
                ...
                estimated_cost=VJustification(
                    time_ms=80, retries=0, backtracks=0, audit_cost=0.3, risk=0.2, tech_debt=0
                ),
                confidence=0.7,
            )
        )
