...
class PolicyEngine:
    ...
    def _run_pytest(
        ...
        try:
            ...
            return (
                Proof(kind="unit", name="pytest", passed=passed, logs=logs, artifacts=[test_file]),
                VJustification(
    ...
    def _run_ruff(
        ...
        try:
            ...
            return (
                Proof(kind="static", name="ruff", passed=passed, logs=logs, artifacts=[code_file]),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
                    backtracks=0,
    ...
    def _run_mypy(
        ...
        try:
            ...
            return (
                Proof(kind="static", name="mypy", passed=passed, logs=logs, artifacts=[code_file]),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
                    backtracks=0,
    ...
    def _check_forbidden_imports(
        ...
        try:
            ...
            return (
                Proof(
                    kind="policy", name="forbidden_imports", passed=passed, logs=logs, artifacts=[]
                ),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
    ...
    def _check_docstring(
        ...
        try:
            ...
            return (
                Proof(kind="policy", name="docstring", passed=passed, logs=logs, artifacts=[]),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
                    backtracks=0,
    ...
    def _check_type_hints(
        ...
        try:
            ...
            return (
                Proof(kind="policy", name="type_hints", passed=passed, logs=logs, artifacts=[]),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
                    backtracks=0,
    ...
    def _check_pure_function(
        ...
        try:
            ...
            return (
                Proof(
                    kind="property", name="pure_function", passed=passed, logs=logs, artifacts=[]
                ),
                VJustification(
                    time_ms=self._get_time_ms() - start_time,
                    retries=0,
